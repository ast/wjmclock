...
Set *either* a Maidenhead =locator= *or* both =lat= and =lon=.

| Key       | Type   | Default  | Description                                |
|-----------+--------+----------+--------------------------------------------|
| =locator= | string | —        | Maidenhead grid locator (2/4/6/8 chars)    |
| =lat=     | float  | —        | Latitude in degrees (-90..90)              |
| =lon=     | float  | —        | Longitude in degrees (-180..180)           |
| =label=   | string | ="HOME"= | Label drawn next to the home marker        |
...
|--------+--------+----------------------------------------------------------|
| =type= | string | =clock=, =map=, or =callsign=                            |
...
| =day_color=       | string | ="#15233f"=         | Lit-ocean fill (must be brighter than =night_color=)        |
| =night_color=     | string | ="#04091e"=         | Deep-night overlay color                                    |
...
| =home_marker=     | bool   | =true=              | Draw the home-location marker (needs =[location]=)          |
| =home_color=      | string | ="#ff5577"=         | Home marker color                                           |
